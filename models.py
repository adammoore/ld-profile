...
including typed dictionaries and classes for managing profile information.
It provides conversion utilities between different data formats and
...
from config import ICONS, BUILD_OPTIONS, HAIR_COLOR_OPTIONS, EYE_COLOR_OPTIONS, RELATIONSHIP_OPTIONS
...
class ProfileData(TypedDict, total=False):
    ...
    This defines the expected fields and their types for profile data
    used throughout the application. The 'total=False' makes all fields
    optional, which is necessary because profiles may be incomplete.
    """
    ...
    emergency_contact: str  # Legacy combined field
...
class Profile:
    ...
    and for converting between different formats. It contains all the
    fields necessary to represent a complete profile, with appropriate
    default values.
    """
    ...
    emergency_contact_mobile: str = ""
    emergency_contact_email: str = ""
    emergency_contact: str = ""  # Legacy field for backward compatibility
    ...
    def height(self) -> str:
        """
        Get formatted height string with both metric and imperial units.
        
        Returns:
            Formatted string with height in cm, feet, and inches
        """
    ...
    def weight(self) -> str:
        """
        Get formatted weight string with both metric and imperial units.
        
        Returns:
            Formatted string with weight in kg and lbs
        """
    ...
    def hair(self) -> str:
        """
        Get combined hair description including color and style.
        
        Returns:
            Combined hair description string
        """
    ...
    def last_seen_datetime(self) -> str:
        """
        Get formatted last seen datetime string.
        
        Returns:
            Formatted date and time string, or empty string if not available
        """
    ...
    def to_dict(self) -> ProfileData:
        ...
        Creates a dictionary representation of the profile, converting
        complex types like dates to strings suitable for storage.
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'Profile':
        ...
        Converts a dictionary representation of a profile back into a
        Profile object, handling type conversions as needed.
        ...
        for attr in [
            ...
            'emergency_contact_mobile', 'emergency_contact_email', 'emergency_contact',
            'build', 'hair_color', 'hair_style', 'eye_color', 'distinguishing_features',
        ...
        if 'gdpr_consent' in data:
            profile.gdpr_consent = bool(data['gdpr_consent'])
    ...
    def validate(self) -> List[str]:
        ...
        Checks required fields and data constraints to ensure the profile
        meets the minimum requirements for saving.
